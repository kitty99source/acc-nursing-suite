...
| Portal URL | `http://internal-portal-server/Reports_MSREPORT/browse/DHB-wide/ACC` | D-02 |
...
| Decline senders | **Same as approval** — `Sample.Staffer@example.test`, `Sample.Manager@example.test`, `Sample.Approver@example.test` | B-05 |
...
- [x] **D-02** Portal URL(s) — full HTTPS:
  ```
  http://internal-portal-server/Reports_MSREPORT/browse/DHB-wide/ACC
  ```
