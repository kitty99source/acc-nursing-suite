...
**Already captured (2026-07-08):** folder navigation, 45 SSRS links, base URL `http://internal-portal-server/Reports_MSREPORT/`.
...
| Step | Action |
| ---- | ------ |
| 1 | Email from `Sample.Manager@example.test` arrives in **ACCDistrictNursing** mailbox |
