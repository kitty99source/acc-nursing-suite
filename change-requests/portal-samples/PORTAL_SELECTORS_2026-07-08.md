...
| Page URL | `http://internal-portal-server/Reports_MSREPORT/report/DHB-wide/ACC/ACC%20District%20Nursing%20Visits` |
...
**Entry URL from checklist D-02:** `http://internal-portal-server/Reports_MSREPORT/browse/DHB-wide/ACC`  
...
1. **Confirmed portal base:** `http://internal-portal-server/Reports_MSREPORT/`
