...
const TOPICS = [
  ...
  { name: 'Client complaints process', terms: ['right to complain', 'complaints procedure', 'health and disability commissioner'] },
  ...
  { name: 'Home modifications', terms: ['housing modification', 'grab-rails', 'building consent'] },
  { name: 'Non-resident / historical claim eligibility', terms: ['injured visitors', 'injured overseas', 'visiting new zealand'] },
